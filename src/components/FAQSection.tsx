...
const FAQS = [
  ...
  { q: 'O suporte e em português?', a: 'Sim, 100%. Nossa equipe de suporte e brasileira e detecta o idioma automaticamente e atende em português, inglês, espanhol e mais de 50 idiomas.' },
  ...
  { q: 'Posso testar antes de assinar?', a: 'Sim. Oferecemos R$5 de crédito gratuito para você testar sem cartão de crédito e sem compromisso.' },
